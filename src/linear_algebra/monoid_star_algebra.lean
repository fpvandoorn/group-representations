...
In this file we define `monoid_star_algebra k G := G →₀ k`, and `add_monoid_star_algebra k G`
...
/-- The product of `f g : monoid_star_algebra k G` is the finitely supported function
